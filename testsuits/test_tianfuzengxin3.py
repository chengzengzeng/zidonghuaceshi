...
class zengxin3(unittest.TestCase):
    ...
    #增信流程
    def test_zengxin3(self):
        #李丹妮-立项申请
        self.driver=self.login('lidanni')
        ...
        # 张锐-业务部负责人审批
        self.driver = self.login('zhangrui')
        # 先定义一下当前窗口句柄　
        first_window = self.driver.current_window_handle
        print(first_window)
        self.driver.find_element_by_xpath(
        ...
        self.driver.find_element_by_xpath(
            '//*[@id="zzxyLiabilityAmount"]').send_keys("0.5")  # 输入责任金额
        self.driver.find_element_by_xpath(
            '//*[@id="zxxyRate"]').send_keys("10")  # 输入费率
        self.driver.find_element_by_xpath(
            '//*[@id="releaseDeadline"]').send_keys("3")  # 输入发行期限
        self.driver.find_element_by_xpath(
        ...
        self.driver.find_element_by_xpath(
            '//*[@id="issueScale"]').send_keys("2")  # 输入发行金额
        self.driver.find_element_by_xpath(
