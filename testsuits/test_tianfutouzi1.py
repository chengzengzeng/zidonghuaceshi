...
class touzi1(unittest.TestCase):
    ...
    def login(self,name):
        ...
        self.driver.get("http://172.16.79.32:8080/zzxypmf/logout")
    ...
    #投资流程
    def test_touzi1(self):
        #尹涛-立项申请
        self.driver=self.login('yintao')
        self.driver.find_element_by_xpath(
            '//*[@id="homepage"]/div[1]/div[1]/ul/li[3]/a/div[2]/div[2]').click()  # 点击项目管理
        self.driver.find_element_by_xpath(
            '//*[@id="projectall"]/div[12]/div/div[1]/ul/li[1]/ul/li[3]/a/div').click()  # 点击投资项目
        # 先定义一下当前窗口句柄　
        ...
        # 立项申请表填写
        self.driver.find_element_by_xpath(
            '//*[@id="projectName"]').send_keys("测试投资1")  # 输入项目名称 自动化测试-投资项目2
        s1 = Select(self.driver.find_element_by_xpath('//*[@id="sonProTypeId"]'))
        s1.select_by_value("2")  # 二级分类，选择信用债（内部增信）
        s1 = Select(self.driver.find_element_by_xpath('//*[@id="productType"]'))
        s1.select_by_value("1")  # 选择券商资管计划
        self.driver.find_element_by_xpath(
        ...
        self.driver.find_element_by_xpath(
            '//*[@id="pingshenhuiZx0--i6"]').send_keys("意见发表")  # 输入意见
        self.driver.find_element_by_xpath(
            '//*[@id="insButton_1"]').click()  # 点击提交总办会按钮
        self.driver.switch_to.default_content()  # 退出iframe的方法,回到了最外层的html页面
        self.driver.find_element_by_xpath(
            '//*[@id="projectinfo"]/div[20]/div[3]/div/button[1]/span').click()  # 点击确定按钮
        sleep(5)
        ...
        self.driver.find_element_by_xpath(
            '//*[@id="pingshenhuiZx0--i3"]').send_keys("2019-12-29")  # 输入过会时间
        s1 = Select(self.driver.find_element_by_xpath('//*[@id="pingshenhuiZx0--i4"]/select'))  # 实例化Select
        s1.select_by_value("2")  # 选择value="仅投资"的项
        self.driver.find_element_by_xpath(
            '//*[@id="pingshenhuiZx0--i5"]').send_keys("4")  # 输入审批过会金额
        s1 = Select(self.driver.find_element_by_xpath('//*[@id="pingshenhuiZx0--i7"]/select'))  # 实例化Select
        s1.select_by_value("同意！")  # 选择value="同意"的项
        self.driver.find_element_by_xpath(
            '//*[@id="pingshenhuiZx0--i6"]').send_keys("意见发表")  # 输入意见
        ...
        self.driver.find_element_by_xpath(
            '//*[@id="tzxyContractName"]').send_keys("合同1")  # 输入合同名称
        self.driver.find_element_by_xpath(
            '//*[@id="tzxyContractNo"]').send_keys("HTBH")  # 输入合同编号
        self.driver.find_element_by_xpath(
            '//*[@id="tzxyTimeLimit"]').send_keys("2")  # 输入期限
        self.driver.find_element_by_xpath(
            '//*[@id="tzlendingTime"]').send_keys("2019-11-01")  # 输入预计放款时间
        self.driver.find_element_by_xpath(
            '//*[@id="tzztTable"]/div[2]/table/tbody/tr[2]/td[2]/input').send_keys("4")  # 输入投资主体金额
        self.driver.find_element_by_xpath(
            '//*[@id="tzztTable"]/div[2]/table/tbody/tr[2]/td[3]/input').send_keys("10")  # 输入收益率
        self.driver.find_element_by_xpath(
        ...
        print(first_window)
        self.driver.find_element_by_xpath(
            '//*[@id="project_product_c"]/div[1]/a').click()  # 点击发行/放款信息按钮
        all_window = self.driver.window_handles
        print(all_window)
        for i in all_window:
            if i != first_window:
        ...
        self.driver.find_element_by_xpath(
            '//*[@id="issueDate"]').send_keys("2019-11-01")  # 输入发行时间
        self.driver.find_element_by_xpath(
            '//*[@id="issueScale"]').send_keys("4")  # 输入发行金额
        self.driver.find_element_by_xpath(
        ...
        self.driver.switch_to.frame("projectInfo--v1")  # 切换到框架中
        s1 = Select(
            self.driver.find_element_by_xpath('//*[@id="commonAuditForm1--i5"]/select'))  # 实例化Select
        s1.select_by_value("同意！")  # 选择value="同意"的项
        self.driver.find_element_by_xpath(
            '//*[@id="commonAuditForm1--i2"]').send_keys("意见发表")  # 输入意见
        self.driver.find_element_by_xpath(
            '//*[@id="insButton_0"]').click()  # 点击通过按钮
        self.driver.switch_to.default_content()  # 退出iframe的方法,回到了最外层的html页面
        self.driver.find_element_by_xpath(
