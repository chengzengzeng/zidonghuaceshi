...
class zengxin1(unittest.TestCase):
    ...
    #增信流程
    def test_zengxin1(self):
        # #王怡飞-立项申请
        # self.driver=self.login('wangyifei')
        ...
        # # 立项申请表填写
        # self.driver.find_element_by_xpath(
        #     '//*[@id="projectName"]').send_keys("自动化测试-增信项目1")  # 输入项目名称 自动化测试-增信项目4
        ...
        #
        # # 张炜-业务部负责人审批
        # self.driver = self.login('zhangwei')
        # # 先定义一下当前窗口句柄　
        # first_window = self.driver.current_window_handle
        # print(first_window)
        # self.driver.find_element_by_xpath(
        ...
        # self.driver.find_element_by_xpath(
        #     '//*[@id="pingshenhuiZx0--i5"]').send_keys("1") #输入审批过会金额
        # s1 = Select(self.driver.find_element_by_xpath('//*[@id="pingshenhuiZx0--i7"]/select'))  # 实例化Select
        # s1.select_by_value("同意！")  # 选择value="同意"的项
        # self.driver.find_element_by_xpath(
        #     '//*[@id="insButton_0"]').click()  # 点击通过按钮
